...
public class WordCountApp {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String intput_path = otherArgs[0];
        String out_path = otherArgs[1];
        FileSystem fileSystem = FileSystem.get(new URI(intput_path), conf);
        ...
        // 1.1指定读取的文件位于哪里
        FileInputFormat.setInputPaths(job, intput_path);
